...
class JticketingCommonHelper
{
	...
	public static function getLanguageConstant()
	{
		...
		Text::script('COM_JTICKETING_TICKET_START_NUMBER_ERROR');
		...
		Text::script('COM_JTICKETING_COMPLETE_PAYMENT_WITHIN');
		Text::script('COM_JTICKETING_TIME_EXPIRED_RETRY_PAYMENT');
