...
class JticketingModelorders extends ListModel
{
	...
	public function Eventdetails()
	{
		...
		$this->_db->setQuery($query);
		$this->result = $this->_db->loadResult();
	...
	public function eventsTypesCountIncrease($order_id)
	{
		...
		if (!empty($order))
		{
			...
			foreach ($orderDetails as $orderdetail)
			{
				...
				{
					$ticketType->count 	= min($ticketType->available, $ticketType->count + $orderdetail->ticketcount);
	...
	public function getValidOrderStatus($status, $allStatuses)
	{
		$unsetOrderStatus = array(
				...
				"C"   => array (0 => "IG", 1 => "P",  2 => "D",   3 => "E", 4 => "UR",  5 => "CRV", 6 => "I"),
				"D"   => array (0 => "IG", 1 => "P",  2 => "C",   3 => "E", 4 => "UR",  5 => "RF", 6 => "CRV", 7 => "RV", 8 => "I"),
				"E"   => array (0 => "P",  1 => "C",  2 => "D",   3 => "UR",4 => "RF",  5 => "CRV", 6 => "RV", 7 => "I"),
				"UR"  => array (0 => "IG", 1 => "P",  2 => "D",   3 => "RF",4 => "CRV", 5 => "RV", 6 => "I"),
				"RF"  => array (0 => "IG", 1 => "P",  2 => "C",   3 => "D", 4 => "E",   5 => "UR", 6 => "CRV", 7 => "RV", 8 => "I"),
				"CRV" => array (0 => "IG", 1 => "P",  2 => "C",   3 => "D", 4 => "E",   5 => "UR", 6 => "RF",  7 => "RV", 8 => "I"),
				"I"   => array (0 => "P",  1 => "C",  2 => "D",   3 => "E", 4 => "UR",  5 => "RF", 6 => "RV"),
				"RV"  => array (0 => "IG", 1 => "P",  2 => "C",   3 => "D", 4 => "E",   5 => "UR", 6 => "RF", 7 => "I"),
				"IG"  => array (0 => "RF", 1 => "CRV", 2 => "RV", 3 => "I"),
		);
	...
	public function getOrderStatusArray()
	{
		$orderStatusArray = array(
				...
				'IG' => Text::_('COM_JTICKEITNG_PSTATUS_INFORMATION_GATHER'),
		);
		...
		if (!empty($order) && !empty($status))
		{
			...
			else
			{
				...
				if ($order->getStatus() === 'C' || 
					in_array($status, [COM_JTICKETING_CONSTANT_ORDER_STATUS_REFUND,
				...
				)
				{
					...
					$orderModel->onAfterOrderFailed($order);
				}
				...
				// set status from completed to reverse and set attendee status as rejected
