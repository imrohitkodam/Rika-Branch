...
class JticketingModelEventForm extends AdminModel
{
	...
	public function save($data)
	{
		...
		if (isset($data['isAuthorizedToEdit']) || $user->authorise('core.create', 'com_jticketing'))
		{
			...
			$vendorData['state']        = "1";
			$data['start_number_for_event_level_sequence'] = (isset($data['start_number_for_event_level_sequence']) && $data['start_number_for_event_level_sequence']) ? $data['start_number_for_event_level_sequence'] : 1;
			...
			if (parent::save($data))
			{
				...
				if ($id)
				{
					...
					foreach ($ticketTypes as $ticketType)
					{
						...
						$tickets['allow_ticket_level_sequence'] = (isset($ticketType['allow_ticket_level_sequence']) && $ticketType['allow_ticket_level_sequence']) ? $ticketType['allow_ticket_level_sequence'] : 0;
						$tickets['start_number_for_sequence'] = (isset($ticketType['start_number_for_sequence']) && $ticketType['start_number_for_sequence']) ? $ticketType['start_number_for_sequence'] : 1;
