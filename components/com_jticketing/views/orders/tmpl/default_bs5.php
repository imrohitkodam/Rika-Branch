...
<div id="jtwrap">
	...
	?>
	<div class="<?php echo JTICKETING_WRAPPER_CLASS; ?> tjBs5 container-fluid all-orders-page">
		...
		<form action="" method="post" name="adminForm" id="adminForm">
			...
			<div id='no-more-tables' class="order overflow-x-auto">
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							<th align="center text-break">
								<?php echo HTMLHelper::_('grid.sort', 'ORDER_ID', 'id', $listDirn, $listOrder); ?>
							</th>
							<th align="center text-break" class="removeWhiteSpace"><?php echo Text::_('EVENT_NAME'); ?></th>
							<?php
							if (in_array('COM_JTICKETING_COLUMN_EVENT_START_DATE', $this->ordersListingFields))
							{
								?>
								<th align="center text-break" class="removeWhiteSpace">
							...
							?>
							<th align="center text-break" class="removeWhiteSpace"><?php echo Text::_('NUMBEROFTICKETS_SOLD'); ?></th>
							<th align="center text-break" class="removeWhiteSpace"><?php echo Text::_('ORIGINAL_AMOUNT'); ?></th>
							<?php
							if (in_array('COM_JTICKETING_FEE', $this->ordersListingFields))
							{
								?>
								<th align="center text-break"><?php echo Text::_('COM_JTICKETING_FEE'); ?></th>
								<?php
							}
							?>
							<?php
							...
							{
								?>
								<th align="center text-break"><?php echo Text::_('DISCOUNT_AMOUNT'); ?></th>
								<?php
							}
							?>
							<?php
							...
							?>
								<th align="center text-break"><?php echo Text::_('TAX_AMOUNT'); ?></th>
							<?php   } ?>
							<th align="center text-break" class="removeWhiteSpace"><?php echo Text::_('PAID_AMOUNT'); ?></th>
							<?php
							if (in_array('COUPON_CODE_DIS', $this->ordersListingFields))
							{
								?>
								<th align="center text-break"><?php echo Text::_('COUPON_CODE_DIS'); ?></th>
								<?php
							}
							?>
							<th align="center text-break"><?php echo HTMLHelper::_('grid.sort', 'PAYMENT_STATUS', 'status', $listDirn, $listOrder); ?>
							</th>
						</tr>
					</thead>
					<?php
					...
					?>
						<tr class="">
							<td class="dis_modal" align="center" data-title="<?php echo Text::_('ORDER_ID'); ?>">
								<?php
								$modalConfig = array('width' => '100%', 'height' => '600px', 'modalWidth' => 80, 'bodyHeight' => 70);
								...
								?>
								<a data-bs-target="#jtOrder<?php echo $passOrderId; ?>" data-bs-toggle="modal" class="af-relative af-d-block"><?php echo $passOrderId; ?>
								</a>
							</td>
							...
							?>
								...
								<td align="center" class="removeWhiteSpace" data-title="<?php echo Text::_('PAY_METHOD'); ?>">
									<?php
							...
							<td align="center" class="text-nowrap" data-title="<?php echo Text::_('ORIGINAL_AMOUNT'); ?>">
							...
							{
								?>
								<td align="center" class="text-nowrap" data-title="<?php echo Text::_('DISCOUNT_AMOUNT'); ?>">
							...
							<td align="center" data-title="<?php echo Text::_('PAYMENT_STATUS'); ?>">
								...
								if (($order->getStatus()) && (!empty($order->processor))) {
									...
									echo HTMLHelper::_('select.genericlist', $validStatus, "pstatus" . $i, 'class="form-select-sm" onChange="jtAdmin.orders.selectStatusOrder(' . $order->id . ',' . $processor . ',this);" data-oldvalue="' . $order->getStatus() . '"', "value", " text", $order->getStatus());
								} else {
					...
					<tr class="jticket_row_head">
						<td colspan="<?php echo $alignedColumn; ?>" align="right" class="hidden-xs hidden-sm">
							<div class="jtright"><b><?php echo Text::_('TOTAL'); ?></b></div>
						</td>
						<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_NUMBEROFTICKETS_SOLD'); ?>">
							<b><?php echo $eventTicketCount; ?></b>
						</td>
						<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_ORIGINAL_AMOUNT'); ?>">
						...
						{
							?>
							<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_COM_JTICKETING_FEE'); ?>">
						...
						{
							?>
							<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_DISCOUNT_AMOUNT'); ?>">
						...
						<?php
						if ($this->jticketingparams->get('allow_taxation')) { ?>
							<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_TAX_AMOUNT'); ?>">
								<b><?php echo $this->utilities->getFormattedPrice($eventTax); ?></b>
							</td>
						<?php   } ?>
						<td align="center" class="text-nowrap" data-title="<?php echo Text::_('TOTAL_PAID_AMOUNT'); ?>">
