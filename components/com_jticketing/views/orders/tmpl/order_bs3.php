...
?>
<div class="container xs-p-0 tjBs3">
	<?php
		?>

	<?php
		?>
	<div class="panel panel-default af-mt-30">
			...
			<div id="printDiv">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="row">
							<div class="bill-to-details col-xs-6">
							...
							<div class="bill-to-details col-xs-6 ">
								<address class="af-mb-10 text-right">
									<?php
									$vendorDetails = '';
									...
									<table class="table table-borderd table-condensed">
										<thead>
											<tr>
												...
												<td class="text-left removeWhiteSpace"><strong><?php echo  Text::_('COM_JTICKETING_PRODUCT_NAM'); ?></strong></td>
												<td class="text-left removeWhiteSpace"><strong><?php echo Text::_('COM_JTICKETING_PRODUCT_QTY'); ?></strong></td>
												<td class="text-left removeWhiteSpace"><strong><?php echo Text::_('COM_JTICKETING_PRODUCT_PRICE'); ?></strong></td>
												<?php
												...
												if ($ExclusiveFee)
													{
														...
														?>
												<td class="text-left removeWhiteSpace"><strong><?php echo Text::_('COM_JTICKETING_PRODUCT_FEE'); ?></strong></td>
												<?php }?>
												<td class="text-left removeWhiteSpace"><strong><?php echo Text::_('COM_JTICKETING_PRODUCT_TPRICE'); ?></strong></td>
											</tr>
										</thead>
										<tbody>
											<?php
											...
											<tr>
												<td><?php echo $i++;?></td>
												<td class="text-left removeWhiteSpace"><?php echo $this->escape($type->title);?></td>
												<td class="text-left removeWhiteSpace"><?php echo $item->count;?></td>
												<td class="text-left removeWhiteSpace"><?php echo $this->utilities->getFormattedPrice($type->price);?></td>
												<?php if ($ExclusiveFee)
													{ ?>
												<td class="text-left removeWhiteSpace"><?php echo $this->utilities->getFormattedPrice($item->totalFee);?>
													<?php } ?>
												<td class="text-left removeWhiteSpace">
													<?php
											...
											<tr>
												...
												<td class="thick-line text-left removeWhiteSpace">
