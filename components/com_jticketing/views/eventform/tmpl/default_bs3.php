...
if ($this->allowedToCreate == 1)
{
	...
	{
		?>
		<div id="jtwrap" class="tjBs3 custom-create-event">
		<?php
							...
							<div class="form-horizontal">
								<div class="row">
										...
										<?php
											echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'details', Text::_('COM_JTICKETING_EVENT_TAB_DETAILS', true));
												...
												echo HTMLHelper::_('bootstrap.addSlide', 'myAccordian', Text::_('COM_JTICKETING_EVENT_TAB_BASIC'), 'collapse1', $class = 'af-mb-10');
													echo $this->loadTemplate('details_bs3');
									...
									<!--tab 5 start-->
										...
										?>
											<div class="col-sm well control-group">
												...
												<div class="col-xs-12 form-group">
													...
													<div class="col-xs-12 col-md-8">
														...
														<br>
														<div class="gallary__validateBtn">
											...
											<div class="col-sm subform-wrapper">
												  <ul class="gallary__media thumbnails">
													 <li class="gallary__media--li hide col-sm-12 col-md-2">
								...
								if ($this->tncForCreateEvent == 1)
								{
									...
									<div class="container">
										<div class="checkbox">
											...
											?>
											<label for="accept_privacy_term" class="col-sm-12 col-xs-12 af-mb-10 checkbox-inline">
												...
												?>
												<a data-target="#jtEventTermsNConditions" data-toggle="modal" class="af-relative af-d-block">
								...
								<div class="clearfix">&nbsp;</div>
								<div class="af-mt-10 col-xs-12">
									<button type="button" id="eventform-save" class="btn btn-default btn-primary com_jticketing_margin validate"
