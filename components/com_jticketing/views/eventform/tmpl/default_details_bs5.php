...
?>
	<div class="row event_details_form af-mt-10">
		...
		<div class="col-md-5 col-xs-12">
			...
			?>
			<div class="row">
				<div class="col-sm-6 col-xs-12 af-mb-10 eventDateTime list-width" id="venue_id">
			...
			?>
				<div class="row">
					<div class="col-sm-9 col-xs-12 af-mb-10 eventDateTime list-width" id="venuechoice_id">
				...
				<div class="row">
					<div class="col-sm-6 col-xs-12 af-mb-10 eventDateTime list-width" id="existingEvent">
