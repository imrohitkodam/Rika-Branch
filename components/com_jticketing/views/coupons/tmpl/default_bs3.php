					...
					<tbody>
						...
						foreach ($this->items as $i => $item)
						{
							...
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="center">
									<?php
									$publish = HTMLHelper::_('jgrid.published', $item->state, $i, 'coupons.', $this->canChange, 'cb');
