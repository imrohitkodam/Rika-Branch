  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
	  <div class="modal-header">
		<h5 class="modal-title af-d-inline-block af-font-500"><?php echo Text::_('COM_JTICKETING_VIEW_ATTENDEES_MOVE_ATTENDEE_DESCRIPTION'); ?></h5>
...
<div id="jtwrap" class="tjBs3">
	<div class="row">
		<div class="col-sm-12 af-ml-10 af-mr-10 af-mt-10">
			<div class="jtFilters">
			<?php
		...
		<div class="col-sm-12 af-ml-10 af-mr-10 af-mt-10">
			<form action="<?php echo Route::_('index.php?option=com_jticketing&view=attendees&Itemid=' . $this->attendee_item_id . $this->component); ?>" method="post" name="adminForm" id="adminForm" class="jtFilters attendees">
				...
				{ 	?>
					<div class="jticketing-tbl af-mt-30" id="no-more-tables">
						<table class="table table-striped left_table table-bordered" id="usersList">
							<thead>
								<tr>
									<?php
						...
						<tbody>
							...
							foreach ($this->items as $i => $item) :
								...
								<tr class="row<?php echo $i % 2; ?>" >
									...
									?>
									<td data-title="<?php echo Text::_('COM_JTICKETING_ENROLMENT_ID');?>">
									...
									<td data-title="<?php echo Text::_('COM_JTICKETING_ENROLMENT_USER_USERNAME');?>">
										<?php
									...
									<td data-title="<?php echo Text::_('COM_JTICKEITNG_ATTENDEE_EMAIL');?>">
										<?php
									...
									if ($this->tmpl !== 'component')
									{
										if (!$item->checkin)
										{
											...
											elseif ($this->enableAttendeeMove && $item->status !== COM_JTICKETING_CONSTANT_ATTENDEE_STATUS_PENDING)
											{
												...
												?>
												<td>
													<input type="button" class="btn btn-primary" id="assign_<?php echo $i;?>" onclick="<?php echo $onchange;?>" value="<?php echo Text::_('COM_JTICKETING_ATTENDESS_VIEW_MOVE_ATTENDEE');?>"/>
												</td>
											<?php 
											}
										...
										<?php
											if ($item->status == 'A') :
											 ?>
												...
												?>
												<a data-target="#attendeeTicketPreview<?php echo $item->id;?>" data-toggle="modal" class="af-relative af-d-block">
											...
											if ($this->collect_attendee_info_checkout) :
												...
												?>
												<a data-target="#attendeeTicketView<?php echo $item->id;?>" data-toggle="modal" class="af-relative af-d-block" data-toggle="modal">
