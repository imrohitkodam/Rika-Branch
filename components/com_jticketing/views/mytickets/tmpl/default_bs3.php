					...
					foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" >
							...
							<?php
								...
								<?php
									$modalConfig = array('width' => '700px', 'height' => '500px', 'modalWidth' => 80, 'bodyHeight' => 70);
								...
								?>
								<a data-target="#ticketPreview<?php echo $item->id;?>" data-toggle="modal" class="af-relative af-d-block" href="javascript:;">
