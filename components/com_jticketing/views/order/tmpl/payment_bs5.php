...
$document->addScriptDeclaration('var intervalCounterDownTime = "' . $this->intervalCounterDownTime . '";');
$document->addScriptDeclaration('var intervalCounterDown;');
...
<div class="row af-mt-10 tjBs5" id="jtwrap">
	<div class="col-sm-8">
		...
		<div class="jticketing-checkout-content" id="payment-info-tab">
			<div id="payment-info" class="jticketing-checkout-steps form-horizontal af-mt-10">
				<span class="col-12 af-mt-10 countdownDateInfo">
								...
								foreach ($this->gateways as $gateway)
								{
									...
									<div class="radio">
										<label>
											...
											<?php echo (count($this->gateways) == 1) ? 'checked="checked"' : '' ?>
