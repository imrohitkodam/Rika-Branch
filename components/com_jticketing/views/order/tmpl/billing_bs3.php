...
<div class="af-mt-10 tjBs3" id="jtwrap">
	<div class="row">
		...
		<div id="billing-info" class="jticketing-checkout-steps">
			<form name="billing_info_form" action="" id="billing_info_form" class="form-validate af-mt-20">
				<div class="panel with-nav-tabs panel-default af-br-5">
					<div class="panel-heading checkout-tab af-pb-0 af-br-t5">
											...
											{?>
												<div>
													...
													<b><?php echo Text::_('COM_JTICKETING_CHECKOUT_REGISTER');?></b>
														<input type="checkbox" name="account_jt" value="register" id="register" class="align-top af-ml-5"/>
													</label>
												</div>
												<?php
											} ?>
													...
													<div id="jt_billmail_msg_div">
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
															<label for="fname" class=" control-label"><?php
																...
																<input id="fname" class="input-medium bill inputbox required validate-name" type="text" value="<?php
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
															<label for="lname" class=" control-label"><?php
																...
																?></label>
																<input id="lname" class="input-medium bill inputbox required validate-name" type="text"
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
																...
																<input id="email1" type="text"
																	class="input-medium bill inputbox required validate-email"
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
																<label for="country_mobile_code"  class="control-label hidden"><?php
																...
																<div class="country_mobile_code">
																	<select name="bill[country_mobile_code]"  id="country_mobile_code"  class="af-mb-10 required" data-chosen="com_jticketing">
																...
																<input type="hidden" class="regexForAttendeeMob" value="<?php echo $regexForAttendeeMob; ?>">
																 <input id="phone" class="input-small bill inputbox required validate-integer" type="text"
													...
													?>
														...
														<div class="col-xs-12 col-sm-6 af-mb-10 business_detail">
																<label for="business_name"  class="control-label"><?php
																	...
																	?></label>
															<div>
																 <input id="business_name" class="input-small bill inputbox validate-blankspace" type="text" value="<?php
														...
														<div class="col-xs-12 col-sm-6 af-mb-10 business_detail">
																<label for="vat_num"  class="control-label"><?php
																	...
																	?></label>
																<div class="">
																 <input id="vat_num" class="input-small bill inputbox validate-blankspace validate-integer" type="text" value="<?php
																...
																<label for="country"  class="control-label"><?php
																	...
																	<?php
																		...
																		echo $this->dropdown = HTMLHelper::_('select.genericlist', $options, 'bill[country]',
																					'class="chzn-done jt_select bill"  required="required" aria-invalid="false"
													...
													if (isset($this->country_config) == 0 && isset($this->state_config) == 0)
													{
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
																...
																<div class="custom-select-height">
																	...
																	'bill[state]',
																	'class="chzn-done jt_select bill" aria-invalid="false" size="1"',
																	'value', 'text', '', 'state');
																	?>
																</div>
														</div>
														...
														if (isset($this->city_config) == 0)
														{
															...
															<div class="col-xs-12 col-sm-6 af-mb-10">
																	<label for="city" class="control-label"><?php
																		...
																		<input id="city" class="input-medium bill inputbox required validate-name" type="text" onkeyup="jtSite.order.validateSpecialChar(this);" value="<?php
														...
														<div class="col-xs-12 col-sm-6 af-mb-10">
																<label for="zip"  class=" control-label"><?php
																	...
																	<input id="zip"  class="input-small bill inputbox required " type="text" onkeyup="jtSite.order.validateSpecialChar(this);" value="<?php
												...
												<div class="form-group">
													<div class="checkbox">
														...
														<label for="accept_privacy_term">
															...
															?>
															<a data-target="#accept_tnc" data-toggle="modal" class="af-relative af-d-inline"> <?php echo Text::_('TERMS_CONDITION');?></a>
										...
										<div id="user-info" class="jticketing-checkout-steps">
											<div class="jticketing-checkout-content checkout-first-step-user-info" id="user-info-tab">
												<div id="login" class="col-sm-8">
													...
													?>
													<div class="text-right af-mb-20">
														<a href="<?php
														echo Route::_('index.php?option=com_users&view=reset&Itemid=' . UsersHelperRoute::getResetRoute(), false);
														?>" target="_blank">
														<?php
													...
													<button type="button" id="button-login" class="orderLogin btn btn-default btn-primary af-mb-20 text-center" data-order-id="<?php echo $this->order->id; ?>">
