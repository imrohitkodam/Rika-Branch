	...
	<div class="<?php echo JTICKETING_WRAPPER_CLASS;?>" id="jtwrap">
		<div class="com_jt_book com_jticketing_button w-100 booking-btn">
			<form action="" method="post" name="ticketform" id="ticketform" class="book-tickets-form">
				<div>
					<h5 class="af-font-600 af-mt-30 af-mb-15 af-ml-15 md-mx-0"><?php echo Text::_('COM_JTICKETING_SELECT_SEATS');?></h5>
					<?php
				...
				<div class="af-mb-30 af-mt-30">
				<div class="af-bg-white af-py-10 af-px-15 overflow-auto">
					<h5 class="af-font-600 af-mt-30 af-mb-15 af-ml-15 md-mx-0">
					...
					<div class="row af-py-5 grey-text">
						...
						{?>
							<div class="col-sm-9 col-xs-7 af-my-5 af-font-600">
								<?php echo Text::_('COM_JTICKETING_SEATS') . " : "; ?>
							</div>
							<div class="col-sm-3 col-xs-5 text-right grey-text">
								<span id="totalTickets" class="text-left"><?php echo $this->order->get('ticketscount'); ?></span>
							</div>


							<div class="col-sm-9 col-xs-7 af-py-5 af-font-600 grey-text">
					...
					<div class="">
							<?php
								...
								{
								?>
							<div id="coupon_troption" class="af-bg-white">
								<div class="input-group af-p-10">
								<?php if (empty($this->order->get('coupon_code')))
										{?>
									<input id="coupon_code" class="focused af-px-5 form-control w-150 pull-right af-mr-5" placeholder="<?php echo Text::_('CUPCODE');?>" name="coupon_code" value="<?php echo $this->order->get('coupon_code', '');?>" >
									<?php } else {?>
									<input id="coupon_code" class="focused af-px-5 form-control w-150 pull-right af-mr-5" name="coupon_code" value="<?php echo $this->order->get('coupon_code', '');?>" readonly>
									<?php }?>
							...
							<?php if (!empty($this->order->get('coupon_code', '')))
								{?>
							<div id= "dis_copon" class="row">
								<div class="col-sm-9 col-xs-7 af-font-600">
						...
						<?php
							...
							?>
						<div class="row border-top af-py-15 hidden-xs">
					...
					<div class="row btn-fixed af-bg-white md-mx-0 af-ml-0 af-mr-0">
							<div class="af-font-600 text-right af-mb-10">
								<?php echo Text::_('COM_JTICKETING_TOTAL_PAY_AFTER_TAX') . ":&nbsp"; ?>
								<span id="total_cost" class="af-pr-5">
									<?php echo $this->order->getAmount(); ?>
								</span>
							</div>
						<button id="proceedCheckout" type="button" data-order-id="<?php echo $this->order->get('id'); ?>" class="proceedCheckout btn btn-primary r-btn pull-right">
