...
?>
	<div class="header-background af-br-t5 bg-gray af-pt-10 af-pb-10 border-bottom">
		<h3 class="af-d-inline-block font-16 af-pl-15 af-m-0 "><strong><?php echo Text::_('COM_JTICKETING_ORDER_YOUR_BOOKED_TICKETS');?></strong></h3>
			<i class="fa fa-chevron-circle-down pull-right af-pt-5 af-mr-10 visible-xs-block" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"></i>
	</div>
	...
	<?php } ?>
		<?php $ticketTypes  = $this->order->getItemTypes();
			...
			foreach ($ticketTypes as $ticketType)
			{
				...
				if ($item->count)
				{ ?>
					<div class="af-mt-15 p-4 af-pt-0 ">
						<div class="row">
							<div class="col-xs-5 af-col-xxs-5 text-left">
...
-->
		...
		<div class="row border-top af-p-5 af-pt-15 af-mt-20">
			...
			<div class="col-sm-5 col-xs-5 text-right af-px-10">
			...
			<div class="">
				...
				if ($this->order->getCouponCode())
				{
					...
					<div id="coupon_troption mt-20" class="af-px-10 af-py-5">
						<div class="pull-left af-my-5">
							<strong>
								<?php echo Text::_('COM_JTICKETING_COUPON_APPLIED');?>
							</strong>
						</div>
						<div class="pull-right af-my-5">
							<?php echo $this->order->getCouponCode(); ?>
						</div>
						<div class="clearfix"></div>
					</div>

					<div id="dis_copon" class="row af-px-10 af-mb-10 overflow-hidden">
						<div class="col-sm-7 col-xs-7">
							<strong>
			...
			<?php	}	?>
						<div class="clearfix"></div>
						<div class="af-mb-10 border-top af-pt-10 af-mt-10">
							<div class="col-sm-7 col-xs-7 af-px-10">
								<strong>
