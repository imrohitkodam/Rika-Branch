...
<div id="jtwrap" class="tjBs5">
	<div id="couponform">
		...
		<div class="row">
			<div class="col-xs-12 col-md-8 createVenue">
				<!--To Do : Add note for register user if has not created a single event-->
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('event_ids');?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('event_ids');?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('name');?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('name');?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('code');?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('code');?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('value'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('value'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('val_type');?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('val_type');?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('limit'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('limit'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('state'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('state'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('max_per_user'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('max_per_user'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('valid_from'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('valid_from'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('valid_to'); ?></div>
					<div class="col-md-8"><?php echo $this->form->getInput('valid_to'); ?></div>
				</div>
				<div class="from-group row mb-3">
					<div class="from-label col-md-4"><?php echo $this->form->getLabel('description'); ?></div>
