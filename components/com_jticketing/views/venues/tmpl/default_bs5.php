...
<form action="<?php echo Route::_('index.php?option=com_jticketing&view=venues'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-5">
			<div class="list-inline events">
				<span class="input-group event__separation">
					<span class="events__search " id="searchVenueInputBox">
						<input
							type="text"
					...
					<a id="searchVenueBtn"  class="btn btn-primary input-group-text" href="javascript:void(0)" title="<?php echo Text::_('COM_JTICKETING_SEARCH_VENUE')?>">
