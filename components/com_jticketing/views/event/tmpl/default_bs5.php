...
?>
<div class="col-xs-12 tjBs5" id="jtwrap">
	...
	<div class="row eventDetails-body">
		<div class="col-sm-4 order-sm-2 eventDetails-venue">
		...
		<div class="col-sm-8 order-sm-1">
			<div class="af-py-15">
				<?php
					...
					echo HTMLHelper::_('uitab.startTabSet', 'JTEventTab', array('active' => $activeTab));

					// #tab1 description start
					if ($this->item->long_description)
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab1', strtoupper(Text::_('COM_JTICKETING_EVENT_TAB_DETAILS'))); ?>
					...
					if ($activity)
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab2', strtoupper(Text::_('COM_JTICKETING_EVENT_ACTIVITY')));?> 
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab3', strtoupper(Text::_('COM_JTICKETING_EVENT_ATTENDEE')));?> 
						<div class="row af-ml-5">
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab4', strtoupper(Text::_('COM_JTICKETING_EVENT_GALLERY')));?>
						<div class="row af-ml-5">
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab5', strtoupper(Text::_('COM_JTICKETING_EVENT_ADDITIONAL_INFO')));?>
						<div class="row">
							<div class="col-sm-12">
								<?php
									if ($this->form_extra)
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'venueAddInfo', strtoupper(Text::_('COM_JTICKETING_EVENT_VENUE_INFO')));?>
							<div class="row">
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab6', strtoupper(Text::_('COM_JTICKETING_VENUE_GALLERY')));?>
						<div class="row af-ml-5">
					...
					{
						echo HTMLHelper::_('uitab.addTab', 'JTEventTab', 'tab7', strtoupper($results[0]['tabName']));?>
						<div class="row af-ml-5">
		...
		<div class="col-xs-12 af-mt-30 order-sm-3">
			<!---Map-->
			<?php
...
<script>
	...
	jQuery(document).ready(function() {
		jQuery('.long_desc .displayFullText').click(function() {
			...
			jQuery('.long_desc .r-more-des'). toggleClass('d-none');
			jQuery('.long_desc .r-less-des'). toggleClass('d-none');
		});
