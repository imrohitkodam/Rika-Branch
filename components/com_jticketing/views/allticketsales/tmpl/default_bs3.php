		...
		<form action="" method="post" name="adminForm" id="adminForm">
			<div id="all" class="row">
				<div class="col-xs-12 div-mt-3">
					<div class="pull-left af-mb-10">
						<?php echo HTMLHelper::_('select.genericlist', $this->status_event, "search_event", 'class="ad-status" size="1"
					onchange="document.adminForm.submit();" name="search_event"', "value", "text", $this->lists['search_event']); ?>
					</div>
					<button type="button" class="btn hasTooltip js-stools-btn-clear" onclick="document.getElementById('search_event').value = '';
					document.adminForm.submit();">
					...
					<div class="col-xs-12 pull-right alert alert-info jtleft"><?php echo Text::_('NODATA'); ?></div>
				</div>
			</div>
