				...
				<form method="post" name="adminForm" id="adminForm" class="form-inline">
					...
					<div class="col-md-12">
						...
						<hr class="hr-condensed" />
						 ...
						 <ul class="pull-right list-inline events ">
							<li class="input-group event__separation">
								<span class="pull-left events__search" id="searchFilterInputBox">
									...
									<input
										...
										class="form-control events__search--input af-bg-faded"
...
-->
							...
							<li class="clear-sepration af-px-10">
							<button
							type="reset"
							...
							<li>
								<?php echo str_replace('size="1"', ' ' ,$this->pagination->getLimitBox()); ?>
							</li>
						</ul>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							?>
								<div class="clearfix">&nbsp;</div>
									<div class="col-xs-12 pull-right alert alert-info"><?php echo Text::_('COM_JTICKETING_EVENTS_NO_EVENTS_FOUND');?></div>
							<?php
							}
							else
							{
												...
												<tr>
													...
													<td class="small com_jticketing_width15" >
														<div class="btn-group myevents">
															...
															?>
															<a class="af-relative af-d-block btn" data-target="#jtEvents<?php echo $row->xref_id;?>" data-toggle="modal"
															class="modal_jform_"
															...
															if($this->params->get('signin_export'))
															{
																...
																?>
																<a class="af-d-block btn" data-target="#jtEventsExport<?php echo $row->xref_id;?>" data-toggle="modal"
																class="modal_jform_"
															...
															if($this->params->get('namecard_export'))
															{
																...
																?>
																<a class="af-d-block btn" data-target="#jtEventsNameCard<?php echo $row->xref_id;?>" data-toggle="modal"
																class="modal_jform_"
