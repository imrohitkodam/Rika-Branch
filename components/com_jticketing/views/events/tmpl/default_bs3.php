...
<div  id="jtwrap" class="tjBs3">
	...
	<form action="" method="post" name="adminForm" id="adminForm" class="">
			<?php
				...
				{ ?>
				<div class="col-xs-10 col-sm-3 col-md-2 searchinputBox af-mb-10">
					<span class="pull-left col-10" id="searchFilterInputBox">
						<input
							type="text"
							...
							class="form-control events__search--input af-bg-faded col-10"
							onchange="this.form.submit();"/>
							<div class="events__search--buttons">
								<a id="searchEventBtn" class="btn-search btn btn-primary btn-transparent hidden-xs" onclick="this.form.submit();" title="<?php echo Text::_('COM_JTICKETING_SEARCH_EVENT')?>">
									<i class="fa fa-search"></i>
								</a>
							</div>
					</span>
				</div>
				<div class="col-xs-2 visible-xs af-p-0 events__mobilefilter--buttons">
