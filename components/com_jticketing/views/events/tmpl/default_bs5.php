	...
	<div class="custom-form-elements">
		<form action="" method="post" name="adminForm" id="adminForm">
			...
			<?php
				...
				{ ?>
				<div class="col-9 col-sm-3 searchinputBox af-mb-10">
					<span class="col-9" id="searchFilterInputBox">
						<input
							type="text"
							...
							class="form-control events__search--input af-bg-faded col-9"
							onchange="this.form.submit();"/>
							<div class="events__search--buttons">
								<a id="searchEventBtn" class="btn-search btn btn-primary btn-transparent d-none d-sm-block" onclick="this.form.submit();" title="<?php echo Text::_('COM_JTICKETING_SEARCH_EVENT')?>">
									<i class="fa fa-search"></i>
								</a>
							</div>
					</span>
				</div>
				<div class="col-3 d-sm-none events__mobilefilter--buttons">
					<a class="btn" href="javascript:void(0)" onclick="jtSite.events.displayMobileFilter();" title="<?php echo Text::_('COM_JTICKETING_FILTER_EVENT')?>">
				...
				<ul class="float-end list-unstyled events af-d-flex align-items-center events__options">
				<?php
						...
						<li class="events__create event__separation">
							<a href="<?php echo $launch_event_url;?>" title="<?php echo Text::_('COM_JTICKETING_EVENTS_CREATE_NEW_EVENT')?>">
								<div class="input-group mb-3">
									...
									<span class="ms-1 d-none d-sm-block"> <?php echo Text::_('COM_JTICKETING_EVENTS_CREATE_EVENT');?></span>
								</div>
							</a>
						</li>
					<?php
					...
					{?>
						<li class="">
							<button type="button" class="btn btn-transparent af-p-0 height-auto d-none" onclick="jQuery('.form-control').val(''); this.form.submit();">
								<i class="fa fa-close" aria-hidden="true"></i>
							</button>
						</li>
					<?php 
			...
			<div class="d-none d-sm-block row" id="mobileFilter">
			<div class="row mt-2">
			<?php
			if ($this->params->get('show_filters') === 'both' || $this->params->get('show_filters') === 'basic')
			{
				...
				{
					?>
					<div class="col-12 col-sm-3 col-md-3 af-mb-10 af-w-auto">
					<?php
				...
				{ ?>
					<div class="tj-filterhrizontal col-12 col-sm-3 col-md-3 af-mb-10 af-w-auto">
						<?php
				...
				{
					?>
					<div class="tj-filterhrizontal float-start col-12 col-sm-3 col-md-3 eventFilter__ht af-mb-10" >
					<?php echo HTMLHelper::_('select.genericlist', $this->eventTypes, "online_events", 'class="form-select" size="1" onchange="this.form.submit();"
			...
			?>
				...
				<div class="af-d-block d-sm-none text-end col-12 af-font-bold af-mb-10">
					<?php if ($this->params->get('show_filters') === 'advanced' || $this->params->get('show_filters') === 'both') : ?>
					...
					<div class="well">
						...
						<p>
							<a href="<?php echo $launch_event_url;?>" title="<?php echo Text::_('COM_JTICKETING_EVENTS_CREATE_NEW_EVENT')?>">
								...
								<span class="d-none d-sm-block"><?php echo Text::_('COM_JTICKETING_EVENTS_CREATE_EVENT');?></span>
							</a>
						</p>
					</div>
				</div>
