...
<form action="<?php echo Route::_('index.php?option=com_jticketing&view=pdftemplate&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
	...
	<div class="form-horizontal tjBs5" id="jtwrap">
		<div class="row form-horizontal-desktop">
			<div class="col-md-8">
				<div class="form-group row" style="display:none">
					<div class="form-label col-md-3"><?php echo $this->form->getLabel('id'); ?></div>
					<div class="col-md-9"><?php echo $this->form->getInput('id'); ?></div>
				</div>
				<div class="form-group row mt-2">
					<div class="form-label col-md-3"><?php echo $this->form->getLabel('event_id'); ?></div>
					<div class="col-md-9"><?php echo $this->form->getInput('event_id'); ?></div>
				</div>
				<div class="form-group row mt-2">
					<div class="form-label col-md-3"><?php echo $this->form->getLabel('body'); ?></div>
				...
				<div class="form-group row mt-2">
					...
					<div class="form-label col-md-3"><?php echo $this->form->getLabel('css'); ?></div>
					<div class="col-md-9"><?php echo $this->form->getInput('css'); ?></div>
				</div>
				...
				<div class="form-group row mt-2">
					<div class="col-xs-12">
						...
						{
							?>
							<button type="submit" class="validate btn btn-success" onclick="Joomla.submitbutton('pdftemplate.save'); return false;">
						...
						<a class="btn btn-default" href="<?php echo $this->ticketPdfsLink;?>" title="<?php echo Text::_('JCANCEL'); ?>">
