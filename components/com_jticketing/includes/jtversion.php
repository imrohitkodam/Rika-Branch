...
/**
 * Version information class for the JTicketing.
 *
 * @since  1.0
 */
class JTicketingJtversion
{
	/**
	 * Product name.
	 *
	 ...
	 * @since  3.5
	 */
	const RELDATE = '23-December-2024';
	 ...
	 * @since  3.5
	 */
	const COPYRIGHT = 'Copyright (C) 2009 - 2024 Techjoomla. All rights reserved.';
	...
	public function __get($name)
	{
		if (defined("Version::$name"))
		{
			...
			return constant("\\JTicketing\\CMS\\Version::$name");
		}
	...
	/**
	 * Compares two a "PHP standardized" version number against the current JTicketing version.
	 *
	 * @param   string  $minimum  The minimum version of the JTicketing which is compatible.
	 *
	...
	/**
	 * Gets a "PHP standardized" version string for the current JTicketing.
	 *
	...
	/**
	 * Gets a version string for the current JTicketing with all release information.
	 *
	...
	/**
	 * Gets a media version which is used to append to JTicketing core media files.
	 *
	 * This media version is used to append to JTicketing core media in order to trick browsers into
	 * reloading the CSS and JavaScript, because they think the files are renewed.
	 * The media version is renewed after JTicketing core update, install, discover_install and uninstallation.
	 *
