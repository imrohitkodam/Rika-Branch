				...
				<tbody>
					...
					foreach ($this->items as $i => $item)
					{
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td><?php echo ($item->valid_from && $item->valid_from != '0000-00-00 00:00:00') ? HTMLHelper::_('date', $item->valid_from, Text::_('DATE_FORMAT_LC4')) : '-';?></td>

							<td><?php echo ($item->valid_to && $item->valid_to != '0000-00-00 00:00:00') ? HTMLHelper::_('date', $item->valid_to, Text::_('DATE_FORMAT_LC4')) : '-';?></td>
