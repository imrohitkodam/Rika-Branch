...
<div id="jtwrap">
    <form action="<?php echo Route::_('index.php?option=com_jticketing&view=attendees&layout=namecard' . $this->component); ?>" method="post" name="adminForm" id="adminForm">
    	<div id="j-main-container">
			...
			<div class="row">
				<div class="col-md-12">
					<input type="button" class="btn  btn-default  btn-success no-print pull-right" onclick="javascript:window.print()" value="<?php echo Text::_('COM_JTICKETING_ATTENDEE_VIEW_PRINT');?>">
				</div>
			</div>
			<div class="row-fluid no-print">
				<hr>
			</div>
        			<div class="row-fluid equal-height-col">
        				<?php
        				foreach($this->items as $item)
        				{ ?>
							<div class="span6 thumbnail equal-items">
							<div class="af-p-10">
